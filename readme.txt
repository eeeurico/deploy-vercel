...
Wordpress plugin to trigger and monitor a deployment on Vercel
...
For more information visit the [Deploy to Vercel](https://github.com/eeeurico/deploy-vercel) on Github
